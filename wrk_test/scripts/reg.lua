...
-- wrk.method = "POST"
-- wrk.body   = "{"email": "2246314330@qq.com", "firstPwd": "e10adc3949ba59abbe56e057f20f883e", "nickName": 随机, "phone": "151XXXXXXXX", "userName": 随机}"
...
request = function()
    local request_body = {
        email = "2246314330@qq.com",
        firstPwd = "e10adc3949ba59abbe56e057f20f883e",
        nickName = randomLetter(15),
        phone = "151"..tostring(random(10000000,99999999)),
